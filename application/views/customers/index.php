...
<div class="row wrapper">
    ...
    <div class="col-sm-7 text-right">
        <div class="form-group">
            ...
            <a class="btn btn-md btn-primary m-b-xs" href="<?php echo base_url(); ?>customers/add">Add Customer</a>
            <a class="btn btn-md btn-primary m-b-xs" href="<?php echo base_url(); ?>customers/add-import">Bulk Prospects</a>
            <a class="btn btn-md btn-primary m-b-xs" href="<?php echo base_url(); ?>customers/add-import2">Bulk Customer with purchase history</a>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-12">
        ...
        <div class="ibox float-e-margins white-bg">
            <div class="ibox-content">
                ...
                <table id="dtCustomersTbl" class="table table-responsive">
                    <thead>
                        <tr>
                            <th>UCode</th>
                            <th>First Name</th>
